<!-- Synced from `/Users/hu_zhehao/Desktop/zzzhehao/note/ecology/Ecological Niche.md` -->


## Ecological Niche

_"The total of the adaptations of an organismic unit."_
...
@winemiller1990 explained:

> [!mini] 
 >_Standard statistical tests cannot be applied to comparisons involving three or more species because dietary overlaps are not independent._

The idea is to:

> [!note] 
> _... generate different replicates of a randomized real system (i.e. pseudo-community, the null model) that can be constructed for comparison with an observed prototype._
